...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit_add'])) {
    ...
    if (!$err) {
        if (update_quantita_prodotto_as_fornitore($partita_iva, $codice_prodotto, $quantita)) {
            $ok = "Scorte prodotto incrementate con successo";
        } else {
            $err = "Errore incremento scorte prodotto";
        }
    }
}
...
<head>
    <meta charset="utf-8">
    <title>Incrementa scorte prodotto</title>
...
<body class="bg-light">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
            <h1 class="h4 mb-0">Incrementa scorte prodotto</h1>
        ...
        <form method="post" class="card p-3 shadow-sm">
            ...
            <div class="col-md-2">
                <label class="form-label">Unità da aggiungere</label>
