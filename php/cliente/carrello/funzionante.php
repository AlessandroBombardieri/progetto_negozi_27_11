        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div class="text-end">
                <div class="mb-2">
                    ...
                    <a class="btn btn-outline-primary" href="../prodotti/home.php">Torna al catalogo</a>
                </div>
            ...
            <form method="post" class="card shadow-sm">
                <div class="card-body">
                    ...
                    <p class="text-muted small mb-3">
                        Gli sconti disponibili sono calcolati dalla funzione get_sconti_applicabili.
                        Se selezioni uno sconto, verranno usati i corrispondenti punti e il totale fattura
                        sarà aggiornato dalla procedura update_totale_fattura.
                    </p>

                    <div class="mb-3">
                        <?php foreach ($opzioni_sconto as $punti): ?>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="sconto" id="sconto_<?= $punti ?>"
